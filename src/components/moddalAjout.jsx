                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h3 class="card-title text-uppercase mb-3 ">Ajouter un usager</h3>
                            <hr />
                            <form onSubmit={(e) => handleSubmit(e)}>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input onChange={(e) => setName(e.target.value)} class="form-control" type="text" placeholder="veuillez entrer le nom.."
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input onChange={(e) => setSurname(e.target.value)} class="form-control" type="text" placeholder="veuillez entrer le prénom.."
                                            id="example-text-input" required />
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input onChange={(e) => setProfession(e.target.value)} class="form-control" type="text" placeholder="veuillez entrer la profession.."
                                            id="example-text-input" required />
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input onChange={(e) => setPhone_number(e.target.value)} class="form-control" type="tel" placeholder="Enter un numéro de  Telephone"
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input onChange={(e) => setAdresse(e.target.value)} class="form-control" type="text" placeholder="veuillez entrer l'adresse.."
                                            id="example-text-input" />
                                    </div>
                                </div>


                                <AjoutVoiture setCarname={setCarname} setCouleur={setCouleur} setMatriculation={setMatriculation}
                                    setDate_of_visit={setDate_of_visit}
                                    setDate_of_next_visit={setDate_of_next_visit}
                                    onSelectHandle={onSelectHandle}  setFilename={setFilename} />
                                    ...
                                    <AjoutContrat setContratStart={setContratStart} setContratDuration={setContratDuration} setContratExpire={setContratExpire} />
                                {/* {addCarTab} */}
                                <div className="">
                                    ...
                                    <button type="submit" class="btn btn-primary " >Enregistrer l'usager</button>
                                    </div>
                                </div>
                            </form>
