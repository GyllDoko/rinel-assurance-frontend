...
export default function OtherVoiture(props) {
    ...
    return (
        ...
        <hr mt-2 />
            <div className="row  mb-3" style={{ textAlign: 'start' }}>
                ...
                <h5>Information concernant le nouveau  véhicule</h5>
            </div>
            <div class="mb-3 row">
                <label for="example-tel-input" class="col-md-2 col-form-label">Marque</label>
                <div class="col-md-10">
                    <input onChange={(e) => props.setCarname(e.target.value)} class="form-control" type="text" 
            ...
            <div class="mb-3 row">
                ...
                <div class="col-md-10">
                    <input onChange={(e) => props.setMatriculation(e.target.value)} class="form-control" type="text"
                        id="example-tel-input" />
                </div>
            </div>
            <div class="mb-3 row">
