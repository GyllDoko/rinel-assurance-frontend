...
export default function AjoutVoiture(props) {
    ...
    const verifyMatricul= (e)=> {
        
        console.log(matricul)
        // axios.post('users/verify_matricule/', {matricul: matricul}).then(res =>
    ...
    return (
        <>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-md-10">
                    <input onChange={(e) => props.setCarname(e.target.value)} class="form-control" type="text" placeholder="Enter le nom du  véhicule"
            ...
            {/* <div class="mb-3 row">
             ...
             <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                        <input  onChange={(e) => props.setCouleur(e.target.value)} class="form-control" type="text" id="example-tel-input" placeholder="veuillez entrer la couleur"/>
                    </div>
                     </div>
            <div class="mb-3 row">
                ...
                } class="form-control" type="text" placeholder="Enter son numéro d'immatriculation"
                        id="example-tel-input" required />
                        {verifymat ? <div class="alert alert-danger alert-dismissible fade show" role="alert">
            ...
            <label for="formFile" class="col-md-2 col-form-label">Carte grise</label>
                ...
                onHandlefile(e)}} class="form-control" type="file" id="formFile" required/>
           </div>
                </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-md-10">
                    <input onChange={(e) =>{ props.setDate_of_next_visit(e.target.value)
                   }} class="form-control" type="date"
                        id="example-date-input"  value={dateOfNext} />
                </div>
            </div>
            <div class="mb-3 row">
