...
const UpdateAjout = (props) => {
  ...
  const handleSubmit = (event) => {
    ...
    axios.put("assureur/save_user/", data).then((res) => {
      if (res.data) {
        axios
          .post("assureur/update_accounts/", {
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-md-10">
                    <input
                      ...
                      class="form-control"
                      type="text"
                      placeholder={userEdit.profession}
                      id="example-text-input"
                    />
                  </div>
                </div>
                <div class="mb-3 row">
                  ...
                  <div class="col-md-10">
                    <input
                      ...
                      class="form-control"
                      type="number"
                      placeholder={userEdit.phone_number}
...
export default connect(mapStateToProps) (UpdateAjout);
